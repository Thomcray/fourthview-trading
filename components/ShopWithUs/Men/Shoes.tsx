    ...
    <section className="px-4 sm:px-6 lg:px-8 py-6 w-full max-w-7xl mx-auto">
      <div className="flex flex-col gap-4">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-emerald-800 to-emerald-700 rounded-xl px-5 py-3 flex flex-row justify-between items-center shadow-md"
        >
          <div className="flex items-center gap-2">
            <span className="text-xl">👟</span>
            <h2 className="font-semibold text-lg text-white">Shoes</h2>
            ...
            {target.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Product Info */}
                  <div className="p-4">
                    <p className="text-gray-800 font-semibold text-sm truncate hover:text-emerald-600 transition-colors">
                      {item.name}
                    </p>

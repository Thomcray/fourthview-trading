...
export default function Trousers() {
  ...
  const productTrousers = products.filter(
    (product) => product.productType.toLowerCase() === "trousers",
  );
    ...
    <section className="px-4 sm:px-6 lg:px-8 py-6 w-full max-w-7xl mx-auto">
      <div className="flex flex-col gap-4">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-purple-800 to-purple-700 rounded-xl px-5 py-3 flex flex-row justify-between items-center shadow-md"
        >
          <div className="flex items-center gap-2">
            <span className="text-xl">👖</span>
            <h2 className="font-semibold text-lg text-white">Trousers</h2>
            ...
            {target.map((item, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Product Info */}
                  <div className="p-4">
                    <p className="text-gray-800 font-semibold text-sm truncate hover:text-purple-600 transition-colors">
                      {item.name}
                    </p>
                ...
                <div className="px-4 pb-4 flex gap-2">
                  <Button
                    variant="outline"
                    className="flex-1 border-purple-200 text-purple-700 hover:bg-purple-50 hover:text-purple-800 font-medium rounded-lg"
                  >

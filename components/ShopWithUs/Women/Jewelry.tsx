    ...
    <section className="px-4 sm:px-6 lg:px-8 py-6 w-full max-w-7xl mx-auto">
      <div className="flex flex-col gap-4">
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-amber-700 to-amber-600 rounded-xl px-5 py-3 flex flex-row justify-between items-center shadow-md"
        >
          <div className="flex items-center gap-2">
            <Gem className="w-5 h-5 text-white" />
            <h2 className="font-semibold text-lg text-white">Jewelry</h2>
              ...
              >
                ...
                >
                  ...
                  <div className="relative bg-gray-50 h-56 sm:h-64">
                    ...
                    {/* Jewelry Badge */}
                    <div className="absolute top-2 right-2 bg-amber-100 text-amber-800 text-xs font-medium px-2 py-1 rounded-full flex items-center gap-1">
                  ...
                  {/* Product Info */}
                  <div className="p-4">
                    <p className="text-gray-800 font-semibold text-sm truncate hover:text-amber-600 transition-colors">
                      {item.name}
                    </p>

...
export default function SimilarItems() {
  return (
    <div className="border-0 py-4 w-full flex flex-col">
      ...
      <div className="w-full h-fit flex flex-row items-center border-0 max-sm:space-x-4 md:space-x-4 py-2 max-sm:pb-12 max-sm:px-2 max-sm:overflow-x-scroll">

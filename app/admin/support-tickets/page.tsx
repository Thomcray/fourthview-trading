...
export default function SupportTickets() {
  const headers = ["ComplaintId", "Customer ID", "Email", "Date", "Status", ""];
  return (
    <div className="w-full flex flex-col px-4 py-4 space-y-4 border rounded-md">
      <h1 className="text-xl text-slate-500 text-left">Support & Tickets</h1>
      ...
      <div className="w-full border rounded-md overflow-hidden">
        <AdminTable headers={headers} caption="A list of support and tickets.">
          <TableRow className="text-slate-500 text-sm font-light">
            <TableCell className="font-medium">INV001</TableCell>
            <TableCell>CC003</TableCell>
